...
public class FaApi extends BaseApi {
     ...
     * @throws Exception err
     */
    public Page<Fa> getFaList2(HttpServletRequest request, Map<String, String> reqBody, Integer pageNo, Integer pageSize, String starttime, String endtime) throws Exception {
        User user = getUserFromCookie(request);
        //请求头
        HttpHeaders headers = getHttpHeaders(request);
        //请求体
    ...
    public List<Fa> getFaList(HttpServletRequest request, Map<String, String> reqBody) throws Exception {
        ...
        String url = baseUrl + "/api/CZF/WYWXJJ_FA_List";
        ResponseEntity<String> responseEntity =
                restTemplate.exchange(url,
     ...
     * @throws Exception err
     */
    public List<Fa> getFaList2(HttpServletRequest request, Map<String, String> reqBody, String starttime, String endtime) throws Exception {
        User user = getUserFromCookie(request);
        //请求头
        HttpHeaders headers = getHttpHeaders(request);
        //请求体
